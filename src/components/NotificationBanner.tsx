...
const NotificationBanner = () => {
  ...
  return (
    <div className="relative bg-black border-b border-white/20 shadow-lg">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 flex-wrap mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-canela text-sm md:text-lg font-semibold text-white tracking-tight">
                ...
                <div className="flex items-center gap-2">
                  <div className="p-1 bg-green-500/20 rounded">
                    <Hotel className="w-3 h-3 md:w-4 md:h-4 text-green-400" />
                  </div>
                  <span className="font-avenir text-sm md:text-base font-medium text-green-400">
                    Inn The Pines remains open
                  </span>
                </div>
              </div>
              
              <p className="font-avenir text-sm md:text-base text-white/90 leading-relaxed">
                The Springs will be closed <span className="font-semibold">July 21st through August 30th, 2025</span> for remodeling. 
                Guests staying at Inn The Pines during the closure will receive a <span className="font-semibold text-green-400">hotel discount</span> when The Springs reopens.
              </p>
            </div>
          </div>
